-- Script LocalScript per visualizzare la Top 100 Playtime su un tabellone
...
print("🏆 [PlaytimeBoard] Inizializzazione tabellone Playtime...")
...
if not scrollingFrame then
	warn("⚠️ [PlaytimeBoard] ScrollingFrame non trovato! Creane uno nel SurfaceGui")
	return
end
...
-- Funzione per convertire secondi in formato tempo leggibile
...
local function updateLeaderboard()
	print("🔄 [PlaytimeBoard] Aggiornamento tabellone Playtime...")
	...
	if not _G.GetTop100Playtime then
		warn("⚠️ [PlaytimeBoard] Funzione _G.GetTop100Playtime non trovata! Assicurati che GlobalLeaderboardScript sia attivo")
		return
	end

	local topPlayers = _G.GetTop100Playtime()
	...
	for i, playerData in ipairs(topPlayers) do
		...
		playtimeLabel.Size = UDim2.new(0.4, 0, 1, 0)
		playtimeLabel.Position = UDim2.new(0.6, 0, 0, 0)
		playtimeLabel.BackgroundTransparency = 1
		playtimeLabel.Text = "⏱️ " .. formatTime(playerData.Playtime)
		playtimeLabel.TextColor3 = Color3.fromRGB(100, 255, 150)
		playtimeLabel.TextSize = 14
		playtimeLabel.Font = Enum.Font.GothamBold
		playtimeLabel.TextXAlignment = Enum.TextXAlignment.Right
		playtimeLabel.Parent = rowFrame

		-- Effetto speciale per i primi 3
		if playerData.Rank <= 3 then
			rowFrame.BackgroundColor3 = Color3.fromRGB(30, 60, 50) -- Sfondo verde scuro
		end
	end
	...
	print("✅ [PlaytimeBoard] Tabellone aggiornato con " .. #topPlayers .. " giocatori")
end
...
print("🏆 [PlaytimeBoard] Tabellone Playtime attivo!")
