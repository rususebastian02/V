...
mainFrame.Position = UDim2.new(0, 20, 0.5, -250) -- Sinistra-centro con margine 20px
...
openButton.Position = UDim2.new(0, 120, 0.5, -400) -- Posizionato sotto la GUI, viene coperto quando si apre
